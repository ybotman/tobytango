...
### Fabián Salas: The Co-Architect

Born **1963 in La Plata**. Trained as a lawyer, moved to Buenos Aires in 1988, and by 1992 became **one of the first professional touring tango teachers in history**. In **1995**, he and Naveira formally launched the **Tango Investigation Group** — later renamed **Cosmotango**.

Salas was Naveira's essential intellectual partner. Together, they applied **principles of dance kinesiology from modern dance** to analyze the physics of tango movement. Their breakthrough was a shift in pedagogical philosophy: from teaching *what* to dance toward teaching *how* to dance.
...
The investigators demonstrated that **all tango movement reduces to three fundamental step types:**

- **Cruce adelante** (front cross) — the foot crosses in front of the body's midline
- **Apertura** (open/side step) — the foot steps to the side
- **Cruce atrás** (back cross) — the foot crosses behind the body's midline

Salas described the breakthrough: "We came up reading the Tango only through: Open, Back, and Front steps and that's it. To 2 sides, that makes 6 — that's all we have in Argentine Tango: **6 different steps**."

### The Turn Code (*Código de Giro*)

The investigation's second breakthrough was recognizing that **the turn is the fundamental structure of all tango**. "One day we came up with this realization that the fundamental structure in Argentine Tango was the turn," Salas recounted. "But you can't see it until you look for it."

One complete turn conventionally takes four steps: **cruce atrás → apertura → cruce adelante → pivot → apertura → pivot**.

### Off-Axis Vocabulary

The investigators systematized the concept of axis into a framework distinguishing **on-axis** work from **off-axis** work:

- ***Volcada*** (from *volcar*, to tip over): the follower tilts inward toward the leader
- ***Colgada*** (from *colgar*, to hang): the follower displaces outward, counterbalanced
- ***Soltada*** (from *soltar*, to release): partners temporarily disconnect

**Systematic off-axis work was the investigation's most visibly original contribution.** Salas has been called "the Father of Volcadas and Colgadas."

---

## The "Nuevo" Question

In **July 2009**, Naveira published his definitive statement:
...
## Practica X and the Movement's Peak

**Practica X**, founded in **2004** by Pablo Inza, Raúl Masciocchi, and Gabriel Bortnik, became the physical symbol of the peak. Located at **Sitio Palermo** in Palermo Hollywood, it offered enough space that dancing in a *ronda* was not obligatory. TangoForge called it "the mecca of Nuevo Tango."

The **CITA festival** (Congreso Internacional de Tango Argentino), co-founded by Fabián Salas in **1999**, became the investigation movement's primary international platform.
...
**"Today I'm a milonguero again. I'm against the people who do not *cabecear*, who don't have codes or respect."**

---

## Legacy

The investigation's framework — the three fundamental steps, the turn code, parallel and crossed systems, the axis vocabulary — is now embedded in tango teaching worldwide, used by traditional and contemporary teachers alike.

The deepest lesson of *la investigación* may be this: **it proved that tango's structure could be decoded, while simultaneously demonstrating that the thing that makes tango *tango* lives somewhere the analysis cannot reach.**

---

## HITM Review Flags

- **Cochabamba 444 founding date**: Sources place it between 1991 and 1993; the task framework suggests 1987 but no corroborating evidence found
- **Contact Improvisation influence**: Stated in secondary analyses but not confirmed in direct quotes from Naveira or Salas
