...
const PRESET_FILES = [
  { value: 'milonga-lisa', label: 'Milonga Lisa (Simple)' },
  { value: 'milonga-traspie', label: 'Milonga Traspie (Double Step)' },
  { value: 'milonga-contratiempo', label: 'Milonga Contratiempo (Off-beat)' }
];
