    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          From Vernon & Irene Castle's sanitized ballroom version through decades of disconnect,
          to Broadway's "Tango Argentino" revelation and today's thriving communities coast to coast.
        </Typography>
      </Box>
