...
export default function ArgentinaTimelinePage() {
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          From its birth in the conventillos of Buenos Aires through the Golden Age, the dark years
          of military rule, and its remarkable rebirth — this is the story of tango in its homeland.
        </Typography>
      </Box>
                    ...
                    <Box sx={{ mb: 3 }}>
                      ...
                      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                        {era.keyFigures.map((figure, i) => (
                          <Chip key={i} icon={<PersonIcon />} label={figure.name} variant="outlined" title={figure.role} />
                        ))}
                      </Box>
                    </Box>
                  )}
      ...
      <Paper sx={{ p: 3, mt: 4 }}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
          ...
          <Button component={Link} href="/tango-history/orchestras" variant="outlined">Orchestras</Button>
        </Box>
      </Paper>
    </Container>
  );
